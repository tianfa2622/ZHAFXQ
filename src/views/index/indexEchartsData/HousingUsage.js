import { getqueryFwsyqk } from "@/api/home/api";
var img =
...
getqueryFwsyqk().then(res => {
  console.log(res);
  let datas = res;
  let array = Object.keys(datas);
  let obj = {};
...
var data = [];
var color = ["#00cfff", "#006ced", "#ffe000", "#ffa800", "#ff5b00", "#ff3000"];
